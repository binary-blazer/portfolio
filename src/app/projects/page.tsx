...
export const metadata: Metadata = {
  title: `Projects | ${config.siteMetadata.title}`,
  icons: {
    ...
    <>
      ...
      >
        ...
        <div className="mb-10 flex flex-col mx-auto">
          <div className="mt-[13rem] flex flex-col items-center justify-center w-full flex-10 px-10 text-center">
            <h1 className="text-5xl font-semibold text-underline-2px button-text">Projects</h1>
