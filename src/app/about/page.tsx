...
export default function About() {
  ...
  useEffect(() => {
    ...
    setLanyardID(
      window.localStorage.getItem('lanyard') ? JSON.parse(window.localStorage.getItem('lanyard')).discord_user.id : null
    );
      ...
      >
        ...
        <div className="mb-10 flex flex-col py-20 mx-auto">
          <div className="mt-[10rem] flex flex-col items-center justify-center w-full flex-10 px-20 text-center">
            <h1 className="text-5xl font-semibold text-underline-2px button-text">About</h1>
                ...
                >
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.96 }}>
                    <LegacyImage
                      src={
                        lanyardLoaded
                          ? `https://cdn.discordapp.com/avatars/${lanyardID}/${lanyardAvatar}.png?size=256`
                          : 'https://cdn.discordapp.com/attachments/971049189377179718/1044214018618953769/unknown.png'
                      }
              ...
              <div>
                ...
                <div className="pb-4 py-4">
                  <h1 className="text-1xl font-bold button-text">
                    Im in love to create and programm new things. &nbsp; <br /> I also love to create new things with my
                    friends and i love to play games. &nbsp; <br /> Thanks for reading{' '}
                    <i className="fas fa-heart" style={{ color: heartColor, cursor: 'pointer' }} />
                  </h1>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2 md:gap-4 mt-10">
                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.96 }}>
                      <button
                        ...
                        target="_blank"
                        className="bg-primary/10 text-black dark:text-white font-display font-semibold text-lg w-full py-2 rounded-md mr-5 button text-white shadow-2xl transition-all duration-200 button button-text border border-primary/20 hover:bg-primary/20 active:bg-primary/30"
                      >
                    ...
                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.96 }}>
                      <button
                        ...
                        target="_blank"
                        className="bg-primary/10 text-black dark:text-white font-display font-semibold text-lg w-full py-2 rounded-md button text-white shadow-2xl transition-all duration-200 button button-text border border-primary/20 hover:bg-primary/20 active:bg-primary/30"
                      >
