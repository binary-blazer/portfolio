  ...
  return (
    <> 
     ...
     <div className="flex flex-col items-center">
      ...
      <h1 className="mx-auto max-w-4xl font-semibold text-5xl font-semibold sm:text-7xl text-black dark:text-white text-center button-text">Hi there, Im <span className="text-primary">{config.siteMetadata.author}</span> <div className="mt-3"> I'm a <span className="text-underline-2px">{config.AboutMePage.developerGrade}</span></div></h1>
          ...
          {_skills
            ? skills
              ? skills.map((_, __) => (
                  <div
                    key={__}
                    className="cursor-pointer bg-gray-300/50 dark:bg-zinc-900/50 p-2 px-4 outline hover:outline-primary outline-black/60 dark:outline-white/50 hover:bg-gray-400/50 dark:hover:bg-gray-700/50 shadow-lg transition-all duration-200 rounded-lg w-full hover:scale-[1.03]"
                  >
