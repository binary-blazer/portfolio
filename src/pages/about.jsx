    ...
    return (
        ...
        <div className="flex flex-col items-center justify-center w-full flex-10 px-20 text-center">
            ...
            <br />
                        ...
                        <p className="text-black dark:text-white text-2xl padding-2 font-bold repsonsiveText">Im a <span className="text-white text-underline-2px font-semibold mt-4 text-2xl repsonsiveText">{config.AboutMePage.developerGrade}</span>,</p>
                        <p className="text-black dark:text-white text-2xl padding-2 font-bold repsonsiveText">from <span className="text-white text-underline-2px font-semibold mt-4 text-2xl repsonsiveText">{config.AboutMePage.yourLand}</span>.</p>
                        </div>
                        <br />
